...
MINI_BOOK_CHAPTER_HASHES = [
  {
    'title' => "Dynamics: Force and Newton's Laws of Motion",
    'contents' => MINI_BOOK_PAGE_HASHES
  }
]
MINI_BOOK_HASH = {
  ...
  'tree' => {
    ...
    'title' => 'College Physics with Courseware',
    'contents' => MINI_BOOK_CHAPTER_HASHES
  }
}
...
HS_PHYSICS_READING_PROCESSING_INSTRUCTIONS = [
  {
    css: ".conceptual-questions, .problems-exercises, [data-element-type=\"conceptual-questions\"], [data-element-type=\"problems-exercises\"], [data-element-type=\"check-understanding\"], [data-type=\"glossary\"]",
    fragments: []
  },
  { css: "[data-type=\"footnote-refs\"]", fragments: ["media"] },
  {
    css: "[data-type=\"note\"].interactive",
    fragments: ["interactive", "exercise"],
    labels: ["phet-explorations"]
  },
